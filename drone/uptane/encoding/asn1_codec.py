...
DATATYPE_DRONE_MANIFEST = 'type__drone_manifest'
DATATYPE_SWARM_MANIFEST = 'type__swarm_manifest'
...
try:
  ...
  SUPPORTED_ASN1_METADATA_MODULES = {
      ...
      DATATYPE_DRONE_MANIFEST: ecu_manifest_asn1_coder,
      DATATYPE_SWARM_MANIFEST: vehicle_manifest_asn1_coder}
...
def convert_signed_der_to_dersigned_json(der_data, datatype):
  ...
  elif datatype == DATATYPE_DRONE_MANIFEST:
    exemplar_object = asn1_spec.ECUVersionManifest()
  elif datatype == DATATYPE_SWARM_MANIFEST:
